...
class BestOmahaHighHandTestCase(unittest.TestCase):
    ...
    def _assert_equal_orders(
        self, board, hand, correct_order, test_order, test_name
    ):
        self.assertEqual(
            first=correct_order,
            second=test_order,
    ...
    def _assert_correct_straight(
        self, board, hand, exp_poss_straights, expected_high_card
    ):
        ...
        missing_items = {
            hole_cards: highest_value
            for hole_cards, highest_value in exp_poss_straights
    ...
    def test_boat_with_3ofkind_in_hand(self):
    ...
    def test_multiple_possible_straights(self):
        ...
        self._assert_correct_straight(
            board, hand, expected_possible_straights, 7
        )

    def test_nut_flush_over_second_nut_flush(self):
        board = ["2h", "Qs", "9d", "5s", "3s"]
        hands = [["7d", "Ts", "Tc", "Ks"], ["7s", "4d", "As", "Jh"]]
    ...
    def test_non_straight(self):
        ...
        self.assertEqual(
            first=possible_straights, second=expected_possible_straights
        )
    ...
    def test_broadway(self):
        ...
        self._assert_correct_straight(
            board, hand, expected_possible_straights, 14
        )
    ...
    def test_many_straight_cards_straight(self):
        ...
        self._assert_correct_straight(
            board, hand, expected_possible_straights, 8
        )
